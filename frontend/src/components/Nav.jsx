...
function Nav() {
    ...
    const handleCityChange = () => {
        const newCity = prompt("Enter your city name:", currentCity || "Varanasi");
        if (newCity && newCity.trim()) {
            dispatch(setCurrentCity(newCity.trim()));
        }
    };
    ...
    return (
        <div className='w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible'>
            ...
            {showSearch && userData.role == "user" && <div className='w-[90%] h-[70px]  bg-white shadow-xl rounded-lg items-center gap-[20px] flex fixed top-[80px] left-[5%] md:hidden'>
                <div onClick={handleCityChange} title="Click to change city" className='flex items-center w-[30%] overflow-hidden gap-[10px] px-[10px] border-r-[2px] border-gray-400 cursor-pointer hover:opacity-80'>
            ...
            <h1 className='text-3xl font-bold mb-2 text-[#ff4d2d]'>FoodieWe</h1>
